...
/// class.
#[derive(Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd, SizeOf, Archive, Serialize, Deserialize)]
pub struct Person {
    pub id: u64,
    pub name: ArcStr,
...
/// Note that Rust can simply derive the equivalent methods on the Java
/// class.
#[derive(Clone, Debug, Default, Eq, Hash, Ord, PartialEq, PartialOrd, SizeOf, Archive, Serialize, Deserialize)]
pub struct Auction {
    pub id: u64,
