...
#[derive(Clone, PartialEq, Eq, PartialOrd, Ord, Hash, Debug, SizeOf, Archive, Serialize, rkyv::Deserialize, serde::Deserialize)]
struct QueryResult {
    // day: Weekday,
    // age: u32,
    // distance: u32,
...
#[derive(
    Clone, PartialEq, Eq, PartialOrd, Ord, Hash, Debug, SizeOf, Archive, Serialize, rkyv::Deserialize, serde::Deserialize,
)]
struct Demographics {
    cc_num: F64,
    first: u32,
