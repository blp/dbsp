...
use num::{Num, One, Zero, traits::Inv};
use size_of::*;
...
impl Decimal {
    ...
    pub fn round_sf(&self, digits: u32) -> Option<Decimal> {
        self.0.round_sf(digits).map(|d| Self(d))
    }
    ...
    pub fn from_f32_retain(n: f32) -> Option<Self> {
        RustDecimal::from_f32_retain(n).map(|d| Self(d))
    }

    pub fn from_f64_retain(n: f64) -> Option<Self> {
        RustDecimal::from_f64_retain(n).map(|d| Self(d))
    }

    pub fn checked_add(self, other: Decimal) -> Option<Decimal> {
        self.0.checked_add(other.0).map(|d| Self(d))
    }
    pub fn checked_sub(self, other: Decimal) -> Option<Decimal> {
        self.0.checked_sub(other.0).map(|d| Self(d))
    }
    pub fn checked_mul(self, other: Decimal) -> Option<Decimal> {
        self.0.checked_mul(other.0).map(|d| Self(d))
    }
    pub fn checked_div(self, other: Decimal) -> Option<Decimal> {
        self.0.checked_div(other.0).map(|d| Self(d))
    }
    pub fn checked_rem(self, other: Decimal) -> Option<Decimal> {
        self.0.checked_rem(other.0).map(|d| Self(d))
    }
