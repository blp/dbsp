...
use crate::{
    ...
    circuit::Scope,
    trace::{ord::OrdValBatch, Batch, Deserializable, Serializer},
...
pub trait Timestamp:
    PartialOrder + Lattice + Debug + Clone + Ord + PartialEq + Eq + Hash + Archive + Serialize<Serializer> + Deserializable + 'static
{
