    ...
    B: Clone + 'static,
{
    ...
    pub fn spill_to_file(&self) -> Stream<C, <B as AsFileBatch>::FileBatch>
    where
        B: AsFileBatch,
    {
    ...
    /// This is like [`Self::integrate_trace`] except that it converts each
    /// batch to type `OB` before inserting it into the
    #[track_caller]
