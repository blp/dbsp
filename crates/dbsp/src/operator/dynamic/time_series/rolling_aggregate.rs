use crate::{
    ...
    dynamic::{
        ClonableTrait, DataTrait, DynDataTyped, DynOpt, DynPair, Erase, Factory, Unit, WeightTrait,
        WithFactory,
    },
    operator::{
        dynamic::{
    ...
    O: DataTrait + ?Sized,
{
    ...
    fn aggregate(&self, cursor: &mut dyn Cursor<V, Unit, (), DynZWeight>, agg: &mut DynOpt<A>) {
        agg.set_none();
    ...
    fn aggregate_and_finalize(
        &self,
        _cursor: &mut dyn Cursor<V, Unit, (), DynZWeight>,
