use crate::{
    ...
    circuit::RootCircuit,
    dynamic::{
        Bool, ClonableTrait, DataTrait, DynOpt, DynPair, DynPairs, DynWeightedPairs, Erase,
        Factory, LeanVec, Unit, WithFactory,
    },
    operator::{
        dynamic::{
...
pub struct AddInputZSetFactories<K: DataTrait + ?Sized> {
    ...
    weighted_pairs_factory: &'static dyn Factory<DynWeightedPairs<DynPair<K, Unit>, DynZWeight>>,
    pairs_factory: &'static dyn Factory<DynPairs<DynPair<K, Unit>, DynZWeight>>,
    pair_factory: &'static dyn Factory<DynPair<DynPair<K, Unit>, DynZWeight>>,
}
    ...
    B: ZSet,
{
    ...
    input_pair_factory: &'static dyn Factory<DynPair<B::Key, Bool>>,
    input_pairs_factory: &'static dyn Factory<DynPairs<B::Key, Bool>>,
    upsert_pair_factory: &'static dyn Factory<DynPair<B::Key, DynOpt<Unit>>>,
    upsert_pairs_factory: &'static dyn Factory<DynPairs<B::Key, DynOpt<Unit>>>,
}
...
impl RootCircuit {
    ...
    pub fn dyn_add_input_zset<K>(
        ...
        ZSetStream<K>,
        CollectionHandle<DynPair<K, Unit>, DynZWeight>,
    )
    where
        K: DataTrait + ?Sized,
    {
        ...
        let zset_handle = <CollectionHandle<DynPair<K, Unit>, DynZWeight>>::new(
    ...
    fn add_set_update<K, B>(
        ...
        input_stream: Stream<Self, Box<DynPairs<K, Bool>>>,
    ) -> Stream<Self, B>
    where
        K: DataTrait + ?Sized,
        B: ZSet<Key = K>,
