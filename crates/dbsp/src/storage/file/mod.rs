...
mod test {
        ...
        T: TwoColumns,
    {
        ...
        let mut layer_file = Writer2::new(&factories0, &factories1,
                                          &BufferCache::default_for_thread(), parameters).unwrap();
        let n0 = T::n0();
        for row0 in 0..n0 {
        ...
        A: DBData,
    {
        ...
        let mut writer = Writer1::new(&factories, &BufferCache::default_for_thread(), parameters).unwrap();
        for row in 0..n {
