...
impl<K, T, R> BatchReaderFactories<K, Unit, T, R> for FileKeyBatchFactories<K, T, R>
where
    K: DataTrait + ?Sized,
    T: Timestamp,
    R: WeightTrait + ?Sized,
...
impl<K, T, R> BatchFactories<K, Unit, T, R> for FileKeyBatchFactories<K, T, R>
where
    K: DataTrait + ?Sized,
    T: Timestamp,
    R: WeightTrait + ?Sized,
...
impl<K, T, R> Merger<K, Unit, T, R, FileKeyBatch<K, T, R>> for FileKeyMerger<K, T, R>
where
    Self: SizeOf,
    K: DataTrait + ?Sized,
    T: Timestamp,
...
impl<'s, K, T, R> Cursor<K, Unit, T, R> for FileKeyCursor<'s, K, T, R>
where
    K: DataTrait + ?Sized,
    T: Timestamp,
    R: WeightTrait + ?Sized,
