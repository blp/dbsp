...
impl<K: DataTrait + ?Sized, R: WeightTrait + ?Sized> BatchReaderFactories<K, Unit, (), R>
...
impl<K: DataTrait + ?Sized, R: WeightTrait + ?Sized> BatchFactories<K, Unit, (), R>
    for VecWSetFactories<K, R>
{
...
impl<K: DataTrait + ?Sized, R: WeightTrait + ?Sized> Merger<K, Unit, (), R, VecWSet<K, R>>
...
impl<'s, K: DataTrait + ?Sized, R: WeightTrait + ?Sized> Cursor<K, Unit, (), R>
    ...
    Self: SizeOf,
{
    ...
    #[inline]
    fn push(&mut self, element: &mut WeightedItem<K, Unit, R>) {
