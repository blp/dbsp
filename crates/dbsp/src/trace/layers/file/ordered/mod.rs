use crate::{
    ...
    dynamic::{
        DataTrait, DynOpt, Erase, Factory, Unit, WeightTrait, WeightTraitTyped, WithFactory,
    },
    storage::file::{
    ...
    R: WeightTrait + ?Sized,
{
    ...
    pub(crate) factories0: FileFactories<K, Unit>,
    ...
    R: WeightTrait + ?Sized,
{
    ...
    file: Reader<StorageBackend, (&'static K, &'static Unit, (&'static V, &'static R, ()))>,
    lower_bound: usize,
}
    ...
    R: WeightTrait + ?Sized,
{
    ...
    writer: Writer2<StorageBackend, K, Unit, V, R>,
}
    ...
    R: WeightTrait + ?Sized,
{
    ...
    cursor: FileCursor<
        ...
        Unit,
        (&'static V, &'static R, ()),
        (&'static K, &'static Unit, (&'static V, &'static R, ())),
    >,
}
